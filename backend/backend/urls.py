...
from api.views import DeleteItemView, CustomerListView, ItemListView, RegisterView, CustomTokenObtainPairView, CustomTokenRefreshView, SaleOrderView, UserDetailsAPIView, VendorListView, PurchaseOrderView
